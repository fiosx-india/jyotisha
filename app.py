...
# ---------------------------------------------------------------
# மெயின் ஆப் லாஜிக் (Main Application Flow)
# ---------------------------------------------------------------
def main():
    # 1. CSS மற்றும் ஹெடரை லோட் செய்யவும்
    load_css()
    show_header()
    
    # 2. மெனுவை பெற்று, அதற்கு ஏற்ற பக்கத்தை காட்டவும்
    menu = show_sidebar()
    
    if menu == "🏠 முகப்பு":
        st.markdown("### 🌟 ஜோதிட செயலிக்கு நல்வரவு!")
        st.write("இடதுபுறம் உள்ள மெனுவைப் பயன்படுத்தி ஜாதகம் அல்லது பொருத்தங்களைப் பார்க்கவும்.")
        ...
        st.warning("முதலில் ஒரு ஜாதகத்தை உருவாக்கவும்.")
        # இங்கே நீங்கள் சேமிக்கப்பட்ட ஜாதகங்களை தேர்வு செய்யும் லாஜிக் சேர்க்கலாம்
